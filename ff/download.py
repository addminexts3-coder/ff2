...
import ff.choices
from ff import curl_builder, logger, process_manager, state_manager, translator
from ff.filesystem import get_file_name, get_file_size, is_file, remove_file
from ff.hash_helper import validate_hash
from ff.types import Command, DownloadProvider, DownloadSet
...
def resolve_download_url_by_provider(download_provider : DownloadProvider, base_name : str, file_name : str) -> Optional[str]:
	download_provider_value = ff.choices.download_provider_set.get(download_provider)
