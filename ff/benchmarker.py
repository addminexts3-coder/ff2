...
import ff.choices
from ff import content_analyser, core, state_manager
from ff.cli_helper import render_table
from ff.download import conditional_download, resolve_download_url
from ff.face_store import clear_static_faces
from ff.filesystem import get_file_extension
from ff.types import BenchmarkCycleSet
from ff.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ ff.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in ff.choices.benchmark_set ]
