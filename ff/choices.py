...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/ff/ff-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'urls':
		...
		'path': '/ff/{base_name}/resolve/main/{file_name}'
	}
}
