...
from ff.common_helper import create_int_metavar
from ff.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from ff.face_analyser import scale_face
from ff.face_helper import paste_back, warp_face_by_face_landmark_5
from ff.face_masker import create_box_mask, create_occlusion_mask
from ff.face_selector import select_faces
from ff.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from ff.processors.live_portrait import create_rotation, limit_expression
from ff.processors.modules.expression_restorer import choices as expression_restorer_choices
from ff.processors.modules.expression_restorer.types import ExpressionRestorerInputs
from ff.processors.types import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw, ProcessorOutputs
from ff.program_helper import find_argument_group
from ff.thread_helper import conditional_thread_semaphore, thread_semaphore
from ff.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from ff.vision import read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ff.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor', 'expression_restorer_areas' ])
