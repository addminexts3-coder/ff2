...
from ff.common_helper import create_float_metavar, create_int_metavar
...
from ff.processors.modules.face_enhancer.types import FaceEnhancerInputs, FaceEnhancerWeight
...
from ff.vision import blend_frame, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ff.jobs.job_store.register_step_keys([ 'face_enhancer_model', 'face_enhancer_blend', 'face_enhancer_weight' ])
