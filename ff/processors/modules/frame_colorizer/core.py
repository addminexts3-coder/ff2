...
from ff.processors.modules.frame_colorizer.types import FrameColorizerInputs
...
from ff.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from ff.vision import blend_frame, read_static_image, read_static_video_frame, unpack_resolution
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ff.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
