...
from ff import config, content_analyser, inference_manager, logger, state_manager, translator, video_manager
from ff.common_helper import is_macos, is_windows
...
from ff.normalizer import normalize_color
from ff.processors.modules.background_remover import choices as background_remover_choices
from ff.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from ff.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ff.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_fill_color', 'background_remover_despill_color' ])
