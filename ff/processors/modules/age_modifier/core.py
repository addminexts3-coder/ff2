...
from ff.common_helper import create_int_metavar, is_macos
...
from ff.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from ff.processors.modules.age_modifier.types import AgeModifierDirection, AgeModifierInputs
from ff.processors.types import ProcessorOutputs
from ff.program_helper import find_argument_group
from ff.thread_helper import thread_semaphore
from ff.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from ff.vision import match_frame_color, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		ff.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if is_macos() and has_execution_provider('coreml'):
		age_modifier.set_providers([ ff.choices.execution_provider_set.get('cpu') ])
